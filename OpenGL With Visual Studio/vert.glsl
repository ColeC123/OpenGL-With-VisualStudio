...
void main() {
    float height1 = 100 * perlinNoise(0.01 * position.xy - 13.789 + time * 0.5, vertSeed) + 50 * perlinNoise(0.02 * position.zy + 7.896 - time * 0.5, vertSeed) + 25 * perlinNoise(0.04 * position.zx - 78.128321 + 0.5 * time, vertSeed);
